...
export default {
    ...
    methods: {
        send() {
            ...
            if (!this.text) {
                ...
                if (typeof (WebSocket) == "undefined") {
                    ...
                    // 构建消息内容，本人消息
                    this.createContent(null, this.user.name, this.text,this.avatar)
                    this.text = '';
                }
            }
        },
        ...
        init() {
            ...
            this.user = localStorage.getItem("store") ? JSON.parse(localStorage.getItem("store")) : {}
            ...
            if (typeof (WebSocket) == "undefined") {
                ...
                console.log("您的浏览器支持WebSocket");
                let socketUrl = "ws:"+ this.baseURL +"/imserver/" + username;
                if (socket != null) {
                    socket.close();
                    socket = null;
                }
